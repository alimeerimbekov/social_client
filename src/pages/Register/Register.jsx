					...
					>
						...
						<div className='register__block'>
							<label className='register__label'>
								...
								<select {...register('day')} className='register__label-select'>
									{
										days.map((day) => (
								...
								<select {...register('months')} className='register__label-select' >
									{
										months.map((month) => (
											<option key={month.en}
								...
								<select {...register('year')} className='register__label-select' >
									{
										years(2009).map((year) => (
